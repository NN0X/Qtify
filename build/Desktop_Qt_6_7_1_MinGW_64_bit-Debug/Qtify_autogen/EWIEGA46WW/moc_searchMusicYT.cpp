/****************************************************************************
** Meta object code from reading C++ file 'searchMusicYT.h'
**
...
#error "The header file 'searchMusicYT.h' doesn't include <QObject>."
...
void SearchMusicYT::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->displaySongsFound(); break;
        case 2: _t->songListDoubleClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
    }
}
